...
function AppUI (){
    return (
        ...
        {/* <React.Fragment> */}
          ...
          <TodoContext.Consumer> {/* Es necesario utilizar las render props por lo que necesita una render funcion
                                      , en este caso una arrow function que contiene valor explicito por eso se agrega todo dentro de un parentesis*/}
            {({
              loading,
              error,
              searchedToDos,
